...
// Actualiza que cursos están desbloqueados según prerrequisitos
...
// Muestra la malla en el contenedor #malla
function mostrarMalla() {
  const contenedor = document.getElementById("malla");
  contenedor.innerHTML = "";

  // Para cualquier cantidad de semestres
  const maxSemestres = Math.max(...cursos.map(c => c.semestre));

  for (let semestre = 1; semestre <= maxSemestres; semestre++) {
